...
A cookie bar plugin that allows a plenty of customizations from the admin panel.
...
== Installation ==
1. Upload the plugin files to the `/wp-content/plugins/wp-reliable-cookie-bar` directory, or install the plugin through the WordPress plugins screen directly.
2. Activate the plugin through the 'Plugins' screen in WordPress
3. Use the Settings->WP Reliable Cookie Bar screen to configure the plugin
...
If you'd like the WP Reliable Cookie Bar to have new functionalities. You can open a new issue on [GitHub](https://github.com/sergioloporto/WP-Reliable-Cookie-Bar "GitHub repo").
